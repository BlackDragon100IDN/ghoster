# GHOSTER AUTO INSTALLER

Cukup jalankan **1 perintah** di terminal (Putty/SSH).
...
```bash
cd /root && rm -rf ghoster randomyakan && \
git clone https://github.com/BlackDragon100IDN/ghoster.git && \
cd ghoster && \
